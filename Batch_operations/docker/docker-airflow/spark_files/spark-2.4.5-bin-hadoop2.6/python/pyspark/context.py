...
class SparkContext(object):
    ...
    def parallelize(self, c, numSlices=None):
        ...
        def reader_func(temp_filename):
            return self._jvm.PythonRDD.readRDDFromFile(
    ...
    def textFile(self, name, minPartitions=None, use_unicode=True):
        ...
        return RDD(
            self._jsc.textFile(name, minPartitions), self, UTF8Deserializer(use_unicode)
        )
    ...
    def wholeTextFiles(self, path, minPartitions=None, use_unicode=True):
        ...
        return RDD(
            ...
            self,
            PairDeserializer(
                UTF8Deserializer(use_unicode), UTF8Deserializer(use_unicode)
            ),
        )
    ...
    def runJob(self, rdd, partitionFunc, partitions=None, allowLocal=False):
        ...
        sock_info = self._jvm.PythonRDD.runJob(
            self._jsc.sc(), mappedRDD._jrdd, partitions
        )

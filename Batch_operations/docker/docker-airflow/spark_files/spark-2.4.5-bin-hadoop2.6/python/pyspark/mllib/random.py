...
class RandomRDDs(object):
    ...
    def poissonRDD(sc, mean, size, numPartitions=None, seed=None):
        ...
        """
        return callMLlibFunc(
            "poissonRDD", sc._jsc, float(mean), size, numPartitions, seed
        )
    ...
    def exponentialRDD(sc, mean, size, numPartitions=None, seed=None):
        ...
        """
        return callMLlibFunc(
            "exponentialRDD", sc._jsc, float(mean), size, numPartitions, seed
        )
    ...
    def logNormalVectorRDD(
        sc, mean, std, numRows, numCols, numPartitions=None, seed=None
    ):
        """
        Generates an RDD comprised of vectors containing i.i.d. samples drawn
    ...
    @since("1.3.0")
    def gammaVectorRDD(
        sc, shape, scale, numRows, numCols, numPartitions=None, seed=None
    ):
        """
        Generates an RDD comprised of vectors containing i.i.d. samples drawn

...
def _jvm():
    ...
    if jvm:
        ...
        raise AttributeError(
            "Cannot load _jvm from SparkContext. Is SparkContext initialized?"
        )
...
class BaseReadWrite(object):
    ...
    def context(self, sqlContext):
        ...
        raise NotImplementedError(
            "Read/Write is not yet implemented for type: %s" % type(self)
        )
...
class MLWriter(BaseReadWrite):
    ...
    def saveImpl(self, path):
        ...
        """
        raise NotImplementedError(
            "MLWriter is not yet implemented for type: %s" % type(self)
        )
...
class MLWritable(object):
    ...
    def write(self):
        ...
        raise NotImplementedError(
            "MLWritable is not yet implemented for type: %r" % type(self)
        )
...
class MLReader(BaseReadWrite):
    ...
    def load(self, path):
        ...
        raise NotImplementedError(
            "MLReader is not yet implemented for type: %s" % type(self)
        )
...
class MLReadable(object):
    ...
    def read(cls):
        ...
        raise NotImplementedError(
            "MLReadable.read() not implemented for type: %r" % cls
        )
    ...
    def _parseMetaData(metadataStr, expectedClassName=""):
        ...
        if len(expectedClassName) > 0:
            assert className == expectedClassName, (
                ...
                + "class name {} but found class name {}".format(

...
from pyspark import SparkContext, keyword_only, since
...
class Binarizer(
    ...
    def __init__(self, threshold=0.0, inputCol=None, outputCol=None):
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.Binarizer", self.uid
        )
...
class LSHModel(JavaModel):
    ...
    def approxNearestNeighbors(
        self, dataset, key, numNearestNeighbors, distCol="distCol"
    ):
        """
        ...
        return self._call_java(
            "approxNearestNeighbors", dataset, key, numNearestNeighbors, distCol
        )
...
class BucketedRandomProjectionLSH(
    ...
    bucketLength = Param(
        Params._dummy(),
        "bucketLength",
        "the length of each hash bucket, "
...
class Bucketizer(
    ...
    @keyword_only
    def __init__(
        self, splits=None, inputCol=None, outputCol=None, handleInvalid="error"
    ):
        """
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.Bucketizer", self.uid
        )
...
class _CountVectorizerParams(JavaParams, HasInputCol, HasOutputCol):
    ...
    def __init__(self, *args):
        ...
        self._setDefault(
            minTF=1.0, minDF=1.0, maxDF=2**63 - 1, vocabSize=1 << 18, binary=False
        )
...
class CountVectorizer(
    JavaEstimator, _CountVectorizerParams, JavaMLReadable, JavaMLWritable
):
    """
...
class CountVectorizerModel(
    JavaModel, _CountVectorizerParams, JavaMLReadable, JavaMLWritable
):
    """
    ...
    @since("2.4.0")
    def from_vocabulary(
        cls, vocabulary, inputCol, outputCol=None, minTF=None, binary=None
    ):
        """
...
class FeatureHasher(
    ...
    * Boolean columns:
    ...
    def __init__(
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.FeatureHasher", self.uid
        )
...
class HashingTF(
    ...
    @keyword_only
    def __init__(
        self, numFeatures=1 << 18, binary=False, inputCol=None, outputCol=None
    ):
        """
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.HashingTF", self.uid
        )
...
class Imputer(JavaEstimator, HasInputCols, JavaMLReadable, JavaMLWritable):
    ...
    def __init__(
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.Imputer", self.uid
        )
...
class MaxAbsScaler(
    ...
    def __init__(self, inputCol=None, outputCol=None):
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.MaxAbsScaler", self.uid
        )
        self._setDefault()
        kwargs = self._input_kwargs
        self.setParams(**kwargs)
...
class MinHashLSH(
    ...
    def __init__(self, inputCol=None, outputCol=None, seed=None, numHashTables=1):
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.MinHashLSH", self.uid
        )
        self._setDefault(numHashTables=1)
        kwargs = self._input_kwargs
        self.setParams(**kwargs)
...
class MinMaxScaler(
    ...
    def __init__(self, min=0.0, max=1.0, inputCol=None, outputCol=None):
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.MinMaxScaler", self.uid
        )
...
class NGram(JavaTransformer, HasInputCol, HasOutputCol, JavaMLReadable, JavaMLWritable):
    ...
    def __init__(self, n=2, inputCol=None, outputCol=None):
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.NGram", self.uid
        )
...
class Normalizer(
    ...
    p = Param(
        Params._dummy(), "p", "the p norm value.", typeConverter=TypeConverters.toFloat
    )
    ...
    def __init__(self, p=2.0, inputCol=None, outputCol=None):
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.Normalizer", self.uid
        )
...
class OneHotEncoderEstimator(
    ...
    @keyword_only
    def __init__(
        self, inputCols=None, outputCols=None, handleInvalid="error", dropLast=True
    ):
        """
...
class QuantileDiscretizer(
    ...
    relativeError = Param(
        Params._dummy(),
        "relativeError",
        "The relative target precision for "
...
class RegexTokenizer(
    ...
    def __init__(
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.RegexTokenizer", self.uid
        )
...
class SQLTransformer(JavaTransformer, JavaMLReadable, JavaMLWritable):
    ...
    def __init__(self, statement=None):
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.SQLTransformer", self.uid
        )
        kwargs = self._input_kwargs
        self.setParams(**kwargs)
...
class StandardScaler(
    ...
    def __init__(self, withMean=False, withStd=True, inputCol=None, outputCol=None):
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.StandardScaler", self.uid
        )
...
@inherit_doc
class StringIndexer(
    JavaEstimator, _StringIndexerParams, JavaMLReadable, JavaMLWritable
):
    """
    ...
    def __init__(
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.StringIndexer", self.uid
        )
        kwargs = self._input_kwargs
        self.setParams(**kwargs)
...
class StringIndexerModel(
    JavaModel, _StringIndexerParams, JavaMLReadable, JavaMLWritable
):
    """
...
class IndexToString(
    ...
    def __init__(self, inputCol=None, outputCol=None, labels=None):
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.IndexToString", self.uid
        )
        kwargs = self._input_kwargs
        self.setParams(**kwargs)
...
class Tokenizer(
    ...
    def __init__(self, inputCol=None, outputCol=None):
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.Tokenizer", self.uid
        )
        kwargs = self._input_kwargs
        self.setParams(**kwargs)
...
class VectorAssembler(
    ...
    def __init__(self, inputCols=None, outputCol=None, handleInvalid="error"):
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.VectorAssembler", self.uid
        )
        self._setDefault(handleInvalid="error")
        kwargs = self._input_kwargs
        self.setParams(**kwargs)
...
class VectorIndexer(
    ...
    @keyword_only
    def __init__(
        self, maxCategories=20, inputCol=None, outputCol=None, handleInvalid="error"
    ):
        """
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.VectorIndexer", self.uid
        )
...
class VectorSlicer(
    ...
    def __init__(self, inputCol=None, outputCol=None, indices=None, names=None):
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.VectorSlicer", self.uid
        )
...
class Word2Vec(
    ...
    def __init__(
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.Word2Vec", self.uid
        )
        self._setDefault(
            vectorSize=100,
            minCount=5,
...
class RFormula(
    ...
    def __init__(
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.RFormula", self.uid
        )
        self._setDefault(
            forceIndexLabel=False,
            stringIndexerOrderType="frequencyDesc",
...
class ChiSqSelector(
    ...
    percentile = Param(
        Params._dummy(),
        "percentile",
        "Percentile of features that selector "
    ...
    def __init__(
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.ChiSqSelector", self.uid
        )
        self._setDefault(
            numTopFeatures=50,
            selectorType="numTopFeatures",
...
class VectorSizeHint(
    ...
    def __init__(self, inputCol=None, size=None, handleInvalid="error"):
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.feature.VectorSizeHint", self.uid
        )
        self._setDefault(handleInvalid="error")

...
class KMeansModel(JavaModel, JavaMLWritable, JavaMLReadable):
    ...
    def computeCost(self, dataset):
        ...
        """
        warnings.warn(
            "Deprecated in 2.4.0. It will be removed in 3.0.0. Use ClusteringEvaluator "
...
class KMeans(
    ...
    def __init__(
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.clustering.KMeans", self.uid
        )
        self._setDefault(
            k=2,
            initMode="k-means||",
...
class LDA(
    ...
    def __init__(
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.clustering.LDA", self.uid
        )
        self._setDefault(
            maxIter=20,
            checkpointInterval=10,
...
class PowerIterationClustering(
    HasMaxIter, HasWeightCol, JavaParams, JavaMLReadable, JavaMLWritable
):
    """
    .. note:: Experimental

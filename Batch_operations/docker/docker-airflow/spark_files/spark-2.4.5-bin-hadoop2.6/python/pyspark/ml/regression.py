...
class LinearRegression(
    ...
    * L2 + L1 (elastic net)
    ...
    loss = Param(
        Params._dummy(),
        "loss",
        "The loss function to be optimized. Supported "
    ...
    def __init__(
        ...
        self._setDefault(
            maxIter=100, regParam=0.0, tol=1e-6, loss="squaredError", epsilon=1.35
        )
...
class LinearRegressionModel(
    JavaModel, JavaPredictionModel, GeneralJavaMLWritable, JavaMLReadable
):
    """
...
class GBTRegressor(
    ...
    def __init__(
        ...
        self._java_obj = self._new_java_obj(
            "org.apache.spark.ml.regression.GBTRegressor", self.uid
        )
        self._setDefault(
            maxDepth=5,
            maxBins=32,
...
class GeneralizedLinearRegression(
    ...
    * "tweedie"  -> power link function specified through "linkPower". \
    ...
    linkPower = Param(
        Params._dummy(),
        "linkPower",
        "The index in the power link function. "

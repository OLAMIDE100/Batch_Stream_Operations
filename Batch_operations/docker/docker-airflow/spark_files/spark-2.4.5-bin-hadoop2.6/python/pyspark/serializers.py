    ...
    def create_array(s, t):
        ...
        if t is not None and pa.types.is_timestamp(t):
            ...
            return pa.Array.from_pandas(
                s.apply(lambda v: v.decode("utf-8") if isinstance(v, str) else v),
                mask=mask,
                type=t,
            )
        elif (
            t is not None
            and pa.types.is_decimal(t)
            and LooseVersion("0.9.0")
            <= LooseVersion(pa.__version__)
            < LooseVersion("0.10.0")
        ):
...
class CompressedSerializer(FramedSerializer):
    ...
    def __init__(self, serializer):
        ...
        ), "serializer must be a FramedSerializer"
        self.serializer = serializer
    ...
    def write(self, bytes):
        ...
        while byte_remaining > 0:
            ...
            if new_pos < self.buffer_size:
                ...
                self.buffer[self.current_pos : self.buffer_size] = bytes[

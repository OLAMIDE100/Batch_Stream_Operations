...
from pyspark.rdd import PythonEvalType, _prepare_for_python_RDD, ignore_unicode_prefix
...
class UserDefinedFunction(object):
    ...
    def returnType(self):
        ...
        if self.evalType == PythonEvalType.SQL_SCALAR_PANDAS_UDF:
            ...
            if isinstance(self._returnType_placeholder, StructType):
                ...
                raise TypeError(
                    "Invalid returnType for grouped map Pandas "
    ...
    def _wrapped(self):
        ...
        assignments = tuple(
            ...
            if a != "__name__" and a != "__module__"
        )
        ...
        wrapper.asNondeterministic = functools.wraps(self.asNondeterministic)(
...
def _test():
    ...
    spark = (
        SparkSession.builder.master("local[4]").appName("sql.udf tests").getOrCreate()
    )
    globs["spark"] = spark

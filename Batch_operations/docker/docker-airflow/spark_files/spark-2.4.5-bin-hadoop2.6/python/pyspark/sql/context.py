...
class SQLContext(object):
    ...
    def registerFunction(self, name, f, returnType=None):
        ...
        """
        warnings.warn(
            "Deprecated in 2.3.0. Use spark.udf.register instead.", DeprecationWarning
        )
    ...
    def registerJavaFunction(self, name, javaClassName, returnType=None):
        ...
        return self.sparkSession.udf.registerJavaFunction(
            name, javaClassName, returnType
        )
    ...
    def createExternalTable(
        self, tableName, path=None, source=None, schema=None, **options
    ):
...
class HiveContext(SQLContext):
    ...
    def _createForTesting(cls, sparkContext):
        ...
        jtestHive = sparkContext._jvm.org.apache.spark.sql.hive.test.TestHiveContext(
            jsc, False
        )
